...
_GITT_ALIASES=(
    ...
    "gitt-bl   | gitt branches-local           | List local branches"
    "gitt-blc  | gitt branches-local --compact | List local branches (compact)"
    "gitt-br   | gitt branches-remote          | List remote branches"
