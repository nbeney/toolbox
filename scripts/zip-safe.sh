#!/usr/bin/env bash
# pack-confidential.sh
# Usage: ./pack-confidential.sh <output-name> <file-or-dir> [file-or-dir ...]
# Example: ./pack-confidential.sh tax2025 ./invoices ./contracts/nda.pdf
...
read -rsp "Enter archive password: " PASSWORD; echo
